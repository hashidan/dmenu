...
static const char *fonts[] = {
    "JetBrainsMonoMedium Nerd Font Mono:style=Medium:size=10",
    "Noto Color Emoji:style=Regular:pixelsize=12:antialias=true:autohint=true",
    "FontAwesome:style=Regular:size=10"};
static const char *prompt =
    NULL; /* -p  option; prompt to the left of input field */
static const char *colors[SchemeLast][2] = {
    /*        fg         bg       */
    [SchemeNorm] = {"#f9f5d7", "#282828"},
    [SchemeSel] = {"#282828", "#bbbbbb"},
    [SchemeSelHighlight] = {"#bbbbbb", "#282828"},
    [SchemeNormHighlight] = {"#bbbbbb", "#222222"},
    [SchemeOut] = {"#282828", "#bbbbbb"},
};
